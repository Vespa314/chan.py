...
class CKLine_Combiner:
    ...
    def test_combine(self, item: CCombine_Item):
    ...
    def try_add(self, unit_kl):
        combine_item = CCombine_Item(unit_kl)
        _dir = self.test_combine(combine_item)
