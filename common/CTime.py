...
class CTime:
    ...
    def __str__(self):
        ...
        # if self.hour == 0:
        #     return f"\033[31m{self.year:04}/{self.month:02}/{self.day:02}\033[0m"
        # else:
        #     return f"{self.year:04}/{self.month:02}/{self.day:02} \033[31m{self.hour:02}:{self.minute:02}\033[0m"
